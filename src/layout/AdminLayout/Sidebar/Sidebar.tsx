...
export default function Sidebar(props: { isShow: boolean; isShowMd: boolean }) {
  ...
  return (
    <div
      className={classNames('sidebar d-flex flex-column position-fixed h-100 border-r border-gray-300 bg-orangePrimary', {
      ...
      id="sidebar"
    >
      <div className="py-3 d-none d-md-flex align-items-center justify-content-center border-b border-gray-300">
